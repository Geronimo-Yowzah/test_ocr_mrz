...
class ResultPage extends StatefulWidget {
  const ResultPage({super.key, required this.information, this.isViewOnly = false});
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text(widget.information.lines!, style: const TextStyle(color: Colors.black, fontSize: 11, overflow: TextOverflow.ellipsis)),
              const SizedBox(
                height: 6,
              ),
            ],
